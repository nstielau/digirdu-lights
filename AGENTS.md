...
consumer reception resumed. A user-triggered hold subsequently produced a native consumer sleep command,
3.018-second fade and alarm handoff without traceback. USB kept its console;
